...
if [[ "$CHOICE" == "<< Back"* ]] || [[ -z "$CHOICE" ]]; then
  ...
  INSTALLER_FILE=$(gum file $Romeokub_PATH/install)
  ...
  case "$INSTALLER" in
  "dev-editor") INSTALLER_FILE="$Romeokub_PATH/bin/Romeokub-sub/install-dev-editor.sh" ;;
  "web-apps") INSTALLER_FILE="$Romeokub_PATH/install/desktop/optional/select-web-apps.sh" ;;
  "dev-language") INSTALLER_FILE="$Romeokub_PATH/install/terminal/select-dev-language.sh" ;;
  "dev-database") INSTALLER_FILE="$Romeokub_PATH/install/terminal/select-dev-storage.sh" ;;
  "ollama") INSTALLER_FILE="$Romeokub_PATH/install/terminal/optional/app-ollama.sh" ;;
  "tailscale") INSTALLER_FILE="$Romeokub_PATH/install/terminal/optional/app-tailscale.sh" ;;
  "geekbench") INSTALLER_FILE="$Romeokub_PATH/install/terminal/optional/app-geekbench.sh" ;;
