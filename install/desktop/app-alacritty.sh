...
cp ~/.local/share/Romeokub/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/Romeokub/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/Romeokub/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/Romeokub/install/desktop/set-alacritty-default.sh
