...
cp ~/.local/share/Romeokub/configs/typora/ia_typora.css ~/.config/Typora/themes/
cp ~/.local/share/Romeokub/configs/typora/ia_typora_night.css ~/.config/Typora/themes/
